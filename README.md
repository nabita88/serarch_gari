...
rumors_opendart                    comprehensive_analyzed_news
     │                                        │
     │ ①AI 분류                               │ ②종목코드 매핑
     │ (StockEventLabelClassifier)            │ (normalized_aliases.json)
     ↓                                        ↓
corp_code: "00126380"                 stock_name: "삼성전자"
summary: "반도체 투자 발표"            event_code: "투자.설비투자"
     │                                        │
     │ ③종목코드 변환                          │ ④종목코드 확정
     │ (stock_list 테이블)                    │
     ↓                                        ↓
...
[2단계] 주가 데이터 조회 및 수익률 계산
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

stock_daily_prices 테이블 조회
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
날짜         종가      설명
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
20241010   65,000   ← 뉴스 발생일
20241011   66,000   ← 앵커 가격 (이후 첫 거래일)
20241014   67,000   ← +1일 (다음 거래일)
20241015   68,000   
20241016   69,000   
20241017   70,000   ← +3일 (3거래일 후)
20241018   71,000
20241021   72,000   ← +5일 (5거래일 후)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

계산 결과:
anchor_price = 66,000
return_1d = ln(67,000 / 66,000) = 0.0150  (1.5%)
return_3d = ln(70,000 / 66,000) = 0.0588  (5.9%)
return_5d = ln(72,000 / 66,000) = 0.0870  (8.7%)


[3단계] 수익률 이력 저장
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

event_returns_history 테이블
┌────────────┬────────────┬──────────┬─────────────┬──────────┬──────────┐
│ stock_code │ event_date │ event_cd │ anchor_pr   │ return1d │ return3d │
├────────────┼────────────┼──────────┼─────────────┼──────────┼──────────┤
│ 005930     │ 20241010   │ 투자.설비│ 66,000      │ 0.0150   │ 0.0588   │
│ 005930     │ 20240905   │ 투자.설비│ 64,500      │ 0.0120   │ 0.0450   │
│ 005930     │ 20240801   │ 투자.설비│ 63,000      │ -0.0050  │ 0.0200   │
│ ...        │ ...        │ ...      │ ...         │ ...      │ ...      │
└────────────┴────────────┴──────────┴─────────────┴──────────┴──────────┘
                                      ↓ 통계 계산
                          "투자.설비투자" 이벤트 통계
                          평균 return_1d = 0.0073  (0.73%)
                          표준편차 = 0.0250


[4단계] 괴리 탐지 (Z-score 계산)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

새로운 뉴스: "삼성전자, 100조 투자 발표"
event_code: "투자.설비투자"

실제 수익률 계산:
actual_return = 0.0150  (1.5%)

과거 통계 조회:
expected_return = 0.0073  (0.73%)
expected_std = 0.0250

Z-score 계산:
z = (0.0150 - 0.0073) / 0.0250
  = 0.0077 / 0.0250
  = 0.308

|z| = 0.308 < 2.0  → 괴리 신호 아님 (정상)


예시2: 과대반응 케이스
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
actual_return = 0.0600  (6.0%)
expected_return = 0.0073  (0.73%)
expected_std = 0.0250

z = (0.0600 - 0.0073) / 0.0250 = 2.108
...
[5단계] news_gaps 테이블 저장
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

INSERT INTO news_gaps
┌────┬──────────┬──────────┬────────────┬──────────┬────────┬─────────┐
│news│stock_code│stock_name│ event_code │ z_score  │direction│magnitude│
├────┼──────────┼──────────┼────────────┼──────────┼────────┼─────────┤
│url1│ 005930   │삼성전자   │투자.설비투자│ +2.108   │ OVER   │ HIGH    │
│url2│ 000660   │SK하이닉스 │투자.설비투자│ -2.550   │ UNDER  │ EXTREME │
│url3│ 005930   │삼성전자   │인수합병     │ +3.200   │ OVER   │ EXTREME │
└────┴──────────┴──────────┴────────────┴──────────┴────────┴─────────┘
    │
    │ actual_return: 0.0600 (6.0%)
    │ expected_return: 0.0073 (0.73%)
